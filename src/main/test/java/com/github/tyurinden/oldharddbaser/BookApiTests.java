...
@SpringBootTest(classes = { OldHardDBaser.class }, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
public class BookApiTests {
    private static final String API_ROOT = "http://localhost:8888/api/books";
